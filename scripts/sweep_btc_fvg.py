...
def load_resampled_data(data_dir, tf_tag, start_date=None, end_date=None):
    ...
    pattern = os.path.join(data_dir, tf_tag, f"btcusdt_{tf_tag}_*.parquet")
    ...
    if not files:
        raise FileNotFoundError(
            ...
            f"(pattern: btcusdt_{tf_tag}_*.parquet)"
        )
...
def main():
    ...
    parser.add_argument("--data-dir", default="/home/cr0wn/binance_data/resampled",
    ...
    parser.add_argument("--output-dir", default=os.path.join(_ROOT, "scripts", "btc_sweep_results"),
